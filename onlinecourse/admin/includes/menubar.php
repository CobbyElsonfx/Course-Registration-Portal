    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li class="navLink px-3 py-2 bg-transparent"><a href=" manage-students.php">Manage Students</a></li>
                <li class="navLink px-3 py-2"><a href="student-registration.php">Registration</a></li>
                <li class="navLink px-3 py-2"><a href="department.php">Department</a></li>
