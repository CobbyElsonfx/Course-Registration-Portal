    ...
    <div class="wrapper">
      ...
      <div id="content">
        ...
        if (isset($_POST['submit'])) {
          ...
          $ret = mysqli_query($con, "insert into students(studentRegno,surname,firstname,otherName,email,contactNumber,level,programme,password,dob, enrollmentDate) values('$studentregno','$surname','$firstname','$otherName','$email','$contactNumber','$level','$programme','$password', '$dob' , '$enrollmentDate' )");
          if ($ret) {
            echo '<script>
      new Notify({
          title: "Registration",
          ...
          if (in_array($fileType, $allowedTypes)) {
            ...
            if (move_uploaded_file($_FILES["excelFile"]["tmp_name"], $targetFilePath)) {
              ...
              foreach ($worksheet->getRowIterator(2) as $row) {
                ...
                $enrollmentDate =  $worksheet->getCell('O' . $row->getRowIndex())->getValue();



                $query = "INSERT INTO students (studentRegno,surname, firstname, otherName, programme ,level, email, contactNumber,dob, enrollmentDate ) 
                          VALUES ('$studentregno','$surname', '$firstname', '$othername' , '$programme', '$level','$email','$contactNumber', '$dob' , '$enrollmentDate')
      ...
      new Notify({
          title: "File Upload",
          text: "Invalid file format. Please upload a valid Excel file.",
          autoclose: true,
          autotimeout: 3000,
          status: "error"
      });
          ...
          <div class="panel-body m-auto" class=" shadow-lg" style="width:80%">
            <form class="card shadow-lg" name="programme" method="post">
              <div class="d-flex flex-row justify-content-between">
                <div class="form-group " style="width:45%">
                  ...
                  <input type="text" style="text-transform: uppercase" class="form-control" id="surname" name="surname" placeholder="surname" required />
                </div>
                <div class="form-group" style="width:45%">
                  <label for="firtname">Firstname </label>
                  <input type="text" style="text-transform: uppercase" class="form-control" id="firtname" name="firstname" placeholder="firstname" required />
                </div>
              </div>
              <div class="form-group">
                <label for="otherName">Other Name</label>
                <input type="text" style="text-transform: uppercase" class="form-control" id="otherName" name="otherName" placeholder="Other Name" />
              </div>
              <div class="d-flex justify-content-between">
                ...
                <div class="form-group" style="width:30%">
                  <label for="enrollmentDate">Date of Admission</label>
                  <input type="date" class="form-control" id="enrollmentDate" name="enrollmentDate" placeholder="date of admission" />
                </div>
              ...
              <div class="d-flex justify-content-between">
                <div class="form-group" style="width:45%">
                  ...
                  <input type="telephone" class="form-control" id="contactNumber" name="contactNumber" placeholder="+233 **** *** ***" required />
                </div>
                <div class="form-group" style="width:45%">
              ...
              <div class="d-flex flex-row justify-content-between">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="studentregno" name="studentregno" onBlur="userAvailability()" placeholder="Index No." required />
              ...
              <div class="form-group">
                ...
                <input type="password" minlength="5" maxlength="15" class="form-control" id="password" name="password" placeholder="Enter password" required />
              </div>
              <button type="submit" name="submit" id="submit" class="cutomBtn btn-default mt-4">Submit</button>
            </form>
            ...
            <form class="card shadow-lg mt-4" method="post" enctype="multipart/form-data">
              <div class="alert alert-warning" role="alert">
                ...
                The Excel file to be uploaded must have headers that exactly match both the order and spelling of the template's headers found in the template.
                Furthermore, the data values should commence from the second row of the template.
                <ul>
                  <li>studentRegno</li>
                  <li>surname</li>
                  <li>firstname</li>
              ...
              <div class="d-flex justify-content-between">
                <button type="submit" name="upload" class="cutomBtn mt-5 btn-default">Upload Excel</button>
                <a href="./uploads/studentsfile.xlsx" download="excel_template">
