    ...
    <div class="wrapper">
      ...
      <?php
        if (isset($_POST['submit'])) {
            ...
            $progrid = $_GET['id'];
            $result =  mysqli_query($con, "delete from programme where id = '$progrid'");
            if ($result) {
                echo '<script>
                    new Notify({
                        title: "Manage Programmes",
              ...
              <div class="panel-body">
                <form name="programme" method="post">
                  <div class="form-group">
                    ...
                    <input type="text" style="text-transform: uppercase" class="form-control" id="Programme" name="programme" placeholder="programme" required />
                  </div> 
                  <div class="form-group ">
                  ...
                  <button type="submit" name="submit" class="cutomBtn btn-default mt-4 form-control">Submit</button>
                </form>
              </div>
            </div>
          </div>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="programme.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
                              <button class="cutomBtn    ">Delete</button>
                            </a>
                          </td>
                        </tr>
                      <?php
