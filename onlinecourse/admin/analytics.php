...
<body>
        ...
        <div id="content">
            ...
            <main>
                ...
                <div class="grid-box">
                    <h2>Level 100</h2>
                    <p>
                        <?php echo "Total Students:" . $totalStudentsLevel100 ?>
                    </p>
                </div>
                ...
                <div class="grid-box">
                    <h2>Level 200</h2>
                    <p>
                        <?php echo "Total Students:" . $totalStudentsLevel200 ?>
                    </p>
                </div>
                ...
                <div class="grid-box">
                    <h2>Level 300</h2>
                    <p>
                        <?php echo "Total Students:" . $totalStudentsLevel300 ?>
                    </p>
                </div>
                ...
                <div class="grid-box">
                    <h2>Level 400</h2>
                    <p>
                        <?php echo "Total Students:" . $totalStudentsLevel400 ?>
                    </p>
                </div>
    ...
    var pieChart = new Chart(ctx, {
        ...
        options: {
            title: {
                display: true,
                text: 'Students by Program Category'
            }
        }
    });
}
    ...
    // Category View
        $.ajax({
            ...
            success: function (data) {
                // Process the data and create a pie chart
                renderPieChart(data);
            },
            error: function () {
