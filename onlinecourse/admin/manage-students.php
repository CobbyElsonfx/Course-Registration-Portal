...
<div class="page-instructions">
        ...
        <p>
            This page allows you to manage student details. You can search for student information using parameters
            such as index number and name. Edit student details, delete , progress, and repeat students buttons are
            among the available options. Additionally, batch progression and reversal can be performed at the beginning
            of the year.
        </p>
        <strong>Important:</strong>
        <p>
            Please use this page with care. Avoid unnecessary page refreshes, and be cautious when performing
            irreversible actions. Batch progression and reversal should only be done at the start of the academic year.
        </p>
    </div>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-row align-items-center">
                                                        ...
                                                        <!-- Form for individual progression -->
                                                            ...
                                                            <button type="submit" class="reverseBtn mt-1"><i class="fa fa-backward"></i> </button>
                                                        </form>

                                                        <form method="get" action="manage-students.php">
                                                            <input type="hidden" name="id" value="<?php echo $row['studentRegno']; ?>">
                                                            <input type="hidden" name="progress" value="update">
                                                            <button type="submit" class=" progressBtn mt-1"><i class="fa fa-forward"></i></button>
                                                        </form>
                                                    ...
                                                    <div class="mt-1">
                                                        <a href="manage-students.php?id=<?php echo $row['studentRegno'] ?>&pass=update" onClick="return confirm('Are you sure you want to reset password?')">
                                                            <button type="submit" name="submit" id="submit" class="btn btn-primary fs-6">Reset Password</button>
                                                        </a>
...
<div class="warning-card">
        ...
        <div class="card-body">
            <div class="col-8">
                <h5 class="card-title">Batch Progression</h5>
                <p class="card-text">Clicking the "Batch Progression" button will perform progression for eligible
                    students. This action may take some time to complete. Please ensure you have considered the
                    implications before proceeding.</p>
                <p class="card-text"><strong>Note:</strong> THIS MUST BE DONE AT THE VERY BEGINNING OF EVERY YEAR</p>
            </div>
            <div class="col-4">
                <div class="action-button" onclick="document.getElementById('batchProgressionForm').submit();">
                    Batch Progression
                </div>
                <form id="batchProgressionForm" method="post">
                    <button type="submit" name="batchProgression" style="display: none;">Batch Progression</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <div class="warning-card">
        ...
        <div class="card-body">
            <div class="col-8">
                ...
                <p class="card-text">Clicking the "Reverse Progression" button will perform a reversal for eligible
                    students. This action may take some time to complete. Please ensure you have considered the
                    implications before proceeding.</p>
            </div>
            <div class="col-4">
                <div class="action-button" onclick="document.getElementById('batchReversalForm').submit();">
                    Reverse Progression
                </div>
                <form id="batchReversalForm" method="post">
                    <button type="submit" name="batchReversal" style="display: none;">Reverse Progression</button>
                </form>
            </div>
        </div>
    </div>
